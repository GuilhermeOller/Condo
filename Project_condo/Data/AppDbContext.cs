...
public class AppDbContext : DbContext
{
    ...
    public DbSet<MorVis> tblMorVis { get; set; }
    ...
    public DbSet<LogCadastro> tblLogCadastroLogin { get; set; }
    public DbSet<LogResetPassword> tblLogResetPasswordLogin { get; set; }
