...
public class VisitanteController : Controller
{
    ...
    public async Task<IActionResult> ObterVisitantes()
    {
        ...
        var visitantes = await _visitanteRepository.ObterVisitantesAsync(idUsuario);

        return Json(visitantes);
    }

    [HttpGet("{idVisitante}")]
    public async Task<IActionResult> ObterVisitantePorId(long idVisitante)
    {
        try
        {
            var visitante = await _context.tblVisitantes
    ...
    public async Task<IActionResult> ObterFestasPorUsuario()
    {
        ...
        var festas = await _visitanteRepository.ObterFestasPorUsuarioAsync(idUsuario);
